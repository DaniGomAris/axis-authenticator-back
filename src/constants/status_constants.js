module.exports = {
  SUCCESS: {
    ...
    ACCEPTED: 202,          // Aceptado pero no procesado aún
  ...
  ERROR: {
    ...
    CONFLICT: 409,          // Conflicto con estado actual (ej: email duplicado)
    PAYLOAD_TOO_LARGE: 413, // Body demasiado grande
    UNSUPPORTED_MEDIA_TYPE: 415, // Tipo de contenido no soportado
    UNPROCESSABLE_ENTITY: 422, // Datos válidos pero no procesables (ej: validación)
    TOO_MANY_REQUESTS: 429, // Límite de peticiones alcanzado (rate limit)
