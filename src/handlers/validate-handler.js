...
function handleValidation(type, context = {}) {
  ...
  switch (type) {
    case "LOGIN_SUCCESS": message = MESSAGES.SUCCESS.LOGIN; break;
    case "LOGIN_FAILED": message = MESSAGES.ERROR.LOGIN_FAILED; break; case "INVALID_TOKEN": message = MESSAGES.ERROR.INVALID_TOKEN; break;
    
    default: message = MESSAGES.ERROR.UNKNOWN; break;
  }
